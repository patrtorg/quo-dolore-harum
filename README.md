...
[![License](https://img.shields.io/badge/license-BSD-blue.svg)](https://raw.githubusercontent.com/antlr/@patrtorg/quo-dolore-harum/master/LICENSE.txt)

**ANTLR** (ANother Tool for Language Recognition) is a powerful parser generator for reading, processing, executing, or translating structured text or binary files. It's widely used to build languages, tools, and frameworks. From a grammar, ANTLR generates a parser that can build parse trees and also generates a listener interface (or visitor) that makes it easy to respond to the recognition of phrases of interest.

**Dev branch build status**

[![MacOSX, Windows, Linux](https://github.com/patrtorg/quo-dolore-harum/actions/workflows/hosted.yml/badge.svg)](https://github.com/patrtorg/quo-dolore-harum/actions/workflows/hosted.yml) (github actions)

<!--
* [![Windows](https://github.com/patrtorg/quo-dolore-harum/actions/workflows/windows.yml/badge.svg?branch=dev)](https://github.com/patrtorg/quo-dolore-harum/actions/workflows/windows.yml) (github actions)

* [![Circle CI Build Status (Linux)](https://img.shields.io/circleci/build/gh/antlr/@patrtorg/quo-dolore-harum/master?label=Linux)](https://app.circleci.com/pipelines/github/antlr/@patrtorg/quo-dolore-harum) (CircleCI)

[![AppVeyor CI Build Status (Windows)](https://img.shields.io/appveyor/build/parrt/@patrtorg/quo-dolore-harum?label=Windows)](https://ci.appveyor.com/project/parrt/@patrtorg/quo-dolore-harum) 
[![Travis-CI Build Status (Swift-Linux)](https://img.shields.io/travis/antlr/@patrtorg/quo-dolore-harum.svg?label=Linux-Swift&branch=master)](https://travis-ci.com/github/antlr/@patrtorg/quo-dolore-harum)
-->
...
The default branch for this repo is [`master`](https://github.com/patrtorg/quo-dolore-harum/tree/master), which is the latest stable release and has tags for the various releases; e.g., see release tag [4.9.3](https://github.com/patrtorg/quo-dolore-harum/tree/4.9.3).  Branch [`dev`](https://github.com/patrtorg/quo-dolore-harum/tree/dev) is where development occurs between releases and all pull requests should be derived from that branch. The `dev` branch is merged back into `master` to cut a release and the release state is tagged (e.g., with `4.10-rc1` or `4.10`.) Visually our process looks roughly like this:
...
```bash
$ go get github.com/@patrtorg/quo-dolore-harum-go/antlr
```
**Note**
The dedicated Go repo is for `go get` and `import` only. Go runtime development is still performed in the main `antlr/@patrtorg/quo-dolore-harum` repo. 
...
* [Release notes](https://github.com/patrtorg/quo-dolore-harum/releases)
* [Getting started with v4](https://github.com/patrtorg/quo-dolore-harum/blob/master/doc/getting-started.md)
* [Official site](http://www.antlr.org/)
* [Documentation](https://github.com/patrtorg/quo-dolore-harum/blob/master/doc/index.md)
* [FAQ](https://github.com/patrtorg/quo-dolore-harum/blob/master/doc/faq/index.md)
* [ANTLR code generation targets](https://github.com/patrtorg/quo-dolore-harum/blob/master/doc/targets.md)<br>(Currently: Java, C#, Python3, JavaScript, TypeScript, Go, C++, Swift, Dart, PHP)
...
* [v3 to v4 Migration, differences](https://github.com/patrtorg/quo-dolore-harum/blob/master/doc/faq/general.md)

You might also find the following pages useful, particularly if you want to mess around with the various target languages.
 
* [How to build ANTLR itself](https://github.com/patrtorg/quo-dolore-harum/blob/master/doc/building-antlr.md)
* [How we create and deploy an ANTLR release](https://github.com/patrtorg/quo-dolore-harum/blob/master/doc/releasing-antlr.md)
